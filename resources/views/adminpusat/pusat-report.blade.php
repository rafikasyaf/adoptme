      ...
      <aside class="main-sidebar hidden-print">
        <section class="sidebar">
          ...
          <ul class="sidebar-menu">
            ...
            <li><a href="article"><i class="fa fa-pencil"></i><span>Article</span></a></li>
            <li><a href="pusat-adoptreq"><i class="fa fa-envelope"></i><span>Adoption Request</span></a></li>
            ...
            <li class="active"><a href="{{url('pusat-report')}}"><i class="fa fa-exclamation-circle"></i><span>Report</span></a></li>
    ...
    <!-- END sidenav -->
      <div class="content-wrapper">
        <div class="page-title">
          <div>
            <h2><i class="fa fa-exclamation-circle"></i> Report</h2>
          </div>
        </div>
        <div class="row">
          <div class="col-md-12">
                ...
                <table class="table table-hover table-bordered" id="sampleTable">
                  <thead>
                    <tr>
                      ...
                      <th>Email</th>
                      <th>Subject</th>
                      <th>Animal's Condition</th>
                      <th>Animal's Location</th>
                      <th>Image</th>
                    </tr>
                  </thead>
                  <tbody>
