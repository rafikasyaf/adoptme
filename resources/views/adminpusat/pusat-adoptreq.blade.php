      ...
      <aside class="main-sidebar hidden-print">
        <section class="sidebar">
          ...
          <ul class="sidebar-menu">
            ...
            <li class="active"><a href="{{url('pusat-adoptreq')}}"><i class="fa fa-envelope"></i><span>Adoption Request</span></a></li>
                ...
                <table class="table table-hover table-bordered" id="sampleTable">
                  ...
                  <tbody>
                    ...
                    <tr>
                      ...
                      <td>{{$v->status}}</td>
                      <td><form class="form" method="post" action="{{url('index/'.$v->id.'/update')}}" enctype="multipart/form-data">
                      {{csrf_field()}}
