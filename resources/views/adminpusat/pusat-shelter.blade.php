      ...
      <aside class="main-sidebar hidden-print">
        <section class="sidebar">
          ...
          <ul class="sidebar-menu">
            ...
            <li class="treeview"><a href=#><i class="fa fa-paw"></i><span>Animal</span><i class="fa fa-angle-right"></i></a></li>
            ...
            <li class="active"><a href="{{url('pusat-shelter')}}"><i class="fa fa-home"></i><span>Shelter</span></a></li>
    ...
    <!-- END sidenav -->
      <div class="content-wrapper">
        <div class="page-title">
          <div>
            <h2><i class="fa fa-users"></i> Shelter</h2>
          </div>
        </div>
        <div class="row">
          <div class="col-md-12">
                ...
                <table class="table table-hover table-bordered" id="sampleTable">
                  ...
                  <tbody>
                    ...
                    <tr>
                      <td>{{$value->name}}</td>
                    <td>{{$value->email}}</td>
                      <td>{{$value->phonenumb}}</td>
                      <td>{{$value->address}}</td>
                      <td>
                        <a class="btn btn-danger" href="{{url('pusat-shelter/'.$value->id.'/delete')}}">Delete </a>
                      </td>
                    </tr>
                    @endforeach
                  </tbody>
