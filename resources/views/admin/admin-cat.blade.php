    ...
    <div class="wrapper">
          ...
          <ul class="sidebar-menu">
            ...
            <li class="treeview"><a href="#"><i class="fa fa-paw"></i><span>Animal</span><i class="fa fa-angle-right"></i></a>
              <ul class="treeview-menu">
                <li class="active"><a href="admin-cat"><img src="admin/images/whitecat.png" class="cats">Cat</a></li>
      ...
      <div class="content-wrapper">
        <div class="page-title">
          <div>
            <h2><img src="admin/images/black-cat.png" class="adminanimal"> CAT</h2>
          </div>
        </div>

        <div class="pull-right" style="margin-bottom: 10px">
          <a href="{{route('admin-cat.create')}}" class="btn btn-primary" >+ Cat</a>
        </div>
                ...
                <table class="table table-hover table-bordered" id="sampleTable">
                  ...
                  <tbody>
                    ...
                    <tr>
                      ...
                      <td>{{$v->vaccinated}}</td>
                      <td>{{$v->spayed}}</td>
                      <td><a class="btn btn-primary" href="{{route('admin-cat.edit',$v->id)}}">Edit </a>
                        <a class="btn btn-danger" href="{{url('admin-cat/'.$v->id.'/delete')}}">Delete </a>
                      </td>
                    </tr>
                    @endforeach
                  </tbody>
